 ...
 */
package org.openmrs.module.ethiopiaformfiller.web.controller;
 ...
 */
@Controller("${rootrootArtifactid}.EtiopiaFormFillerController")
@RequestMapping(value = "module/${rootArtifactid}/${rootArtifactid}.form")
public class EtiopiaFormFillerController {
